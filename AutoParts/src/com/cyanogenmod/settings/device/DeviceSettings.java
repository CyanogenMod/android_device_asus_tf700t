...
public class DeviceSettings extends PreferenceActivity {
    ...
    public static class CpuSettingsFragment
        ...
        private static final String CPU_SETTING_POWER_SAVE = "0";
        private static final String CPU_SETTING_BALANCE = "1";
        private static final String CPU_SETTING_PERFORMANCE = "2"; // Default
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            String currCpuMode = CPU_SETTING_PERFORMANCE;
            if (SystemProperties.get(CPU_PROPERTY) != null)
                currCpuMode = SystemProperties.get(CPU_PROPERTY);

            mCpuMode = (ListPreference)findPreference(PREFERENCE_CPU_MODE);
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (key.compareTo(PREFERENCE_CPU_MODE) == 0) {
        ...
        private int getCpuModeIndex(String mode) {
            if (mode.equals(CPU_SETTING_POWER_SAVE)) {
                return Integer.parseInt(CPU_SETTING_POWER_SAVE);
            }
            if (mode.equals(CPU_SETTING_BALANCE)) {
                return Integer.parseInt(CPU_SETTING_BALANCE);
            }
            return Integer.parseInt(CPU_SETTING_PERFORMANCE);
        }
    }
